...
# NOTE: Be sure to replace all instances of 198.199.120.45
...
ssh root@198.199.120.45 "rm -rf /root/go/src/chefhub.pw"
echo "  Code deleted successfully!"

echo "  Uploading code..."
rsync -avr --exclude '.git/*' --exclude 'tmp/*' \
  --exclude 'images/*' ./ \
  root@198.199.120.45:/root/go/src/chefhub.pw/
echo "  Code uploaded successfully!"

echo "  Go getting deps..."
ssh root@198.199.120.45 "export GOPATH=/root/go; \
...
echo "  Moving assets..."
ssh root@198.199.120.45 "cd /root/app; \
...
ssh root@198.199.120.45 "sudo service chefhub.pw restart"
echo "  Server restarted successfully!"

echo "  Restarting Caddy server..."
ssh root@198.199.120.45 "sudo service caddy restart"
